<footer class="bg-[#0d141c] text-white mt-16">
  <div class="max-w-[960px] mx-auto px-5 py-12">
    <!-- Main Footer Content -->
    <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
      ...
      <div class="col-span-1 md:col-span-2">
        ...
        <p class="text-gray-300 text-sm leading-relaxed mb-4">
          Empowering students with high-quality computer science projects and comprehensive learning resources.
        </p>
        <!-- Social Links -->
      ...
      <div>
        ...
        <ul class="space-y-2">
          ...
          <li><a href="#" class="text-gray-300 hover:text-white transition-colors text-sm">Projects</a></li>
      ...
      <div>
        ...
        <ul class="space-y-2">
          ...
          <li><a href="#" class="text-gray-300 hover:text-white transition-colors text-sm">Documentation</a></li>
          <li><a href="#" class="text-gray-300 hover:text-white transition-colors text-sm">FAQs</a></li>
          <li><a href="#" class="text-gray-300 hover:text-white transition-colors text-sm">Contact Support</a></li>
        </ul>
      </div>
    </div>
